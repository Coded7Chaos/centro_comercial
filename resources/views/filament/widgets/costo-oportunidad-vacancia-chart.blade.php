@php
    ...
    $chartMinWidth = max(2200, count($cachedData['labels'] ?? []) * 160);
@endphp
            ...
            <div
                ...
                {{
                    (new ComponentAttributeBag)
                        ...
                        ->class([
                            'fi-wi-chart-canvas-ctn fi-wi-chart-canvas-ctn-no-aspect-ratio',
                        ])
                }}
                style="min-width: {{ $chartMinWidth }}px; height: 520px;"
            >
                <canvas
                    x-ref="canvas"
